...
namespace
{
  constexpr std::array keyTranslation {
    ...
    std::tuple("WM/ContentGroupDescription", /*"WORK"/*/"GROUPING"/*dro change*/, ASF::Attribute::UnicodeType),
    ...
    std::tuple("WM/Publisher", "PUBLISHER", ASF::Attribute::UnicodeType),
    std::tuple("WM/Category", "CATEGORY", ASF::Attribute::UnicodeType),
    std::tuple("WM/Director", "DIRECTOR", ASF::Attribute::UnicodeType),
    std::tuple("WM/PartOfSet", "DISC", ASF::Attribute::UnicodeType),
    std::tuple("WM/ProviderRating", "RATING", ASF::Attribute::UnicodeType),
    std::tuple("WM/SharedUserRating", "RATING", ASF::Attribute::UnicodeType),
